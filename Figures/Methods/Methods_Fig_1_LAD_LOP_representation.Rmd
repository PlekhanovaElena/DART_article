...
```{r}
beech = read.csv("./LOPs/beech_middle.csv")[,c(2,3,5)]
colnames(beech)[2:3] = paste0("beech", c("_refl", "_transm"))
beech$beech_abs = 100 - beech$beech_refl - beech$beech_transm
elm = read.csv("./LOPs/elm_middle.csv")[,c(2,3,5)]
colnames(elm)[2:3] = paste0("elm", c("_refl", "_transm"))
elm$elm_abs = 100 - elm$elm_refl - elm$elm_transm
eucalyptus = read.csv("./LOPs/eucalyptus_g_m.csv")[,c(2,3,5)]
colnames(eucalyptus)[2:3] = paste0("eucalyptus", c("_refl", "_transm"))
eucalyptus$eucalyptus_abs = 100 - eucalyptus$eucalyptus_refl - eucalyptus$eucalyptus_transm
deciduous = read.csv("./LOPs/leaf_deciduous.csv")[,c(2,3,5)]
colnames(deciduous)[2:3] = paste0("deciduous", c("_refl", "_transm"))
deciduous$deciduous_abs = 100 - deciduous$deciduous_refl - deciduous$deciduous_transm
picea = read.csv("./LOPs/picea_abies_leaf.csv")[,c(2,3,5)]
colnames(picea)[2:3] = paste0("picea", c("_refl", "_transm"))
picea$picea_abs = 100 - picea$picea_refl - picea$picea_transm
populus = read.csv("./LOPs/populus_tremuloides_leaf.csv")[,c(2,3,5)]
colnames(populus)[2:3] = paste0("populus", c("_refl", "_transm"))
populus$populus_abs = 100 - populus$populus_refl - populus$populus_transm
